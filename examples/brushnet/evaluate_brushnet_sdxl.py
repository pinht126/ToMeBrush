...
parser.add_argument('--brushnet_ckpt_path', 
                    type=str, 
                    default="data/ckpt/segmentation_mask_brushnet_ckpt_sdxl_v0")
parser.add_argument('--base_model_path', 
                    type=str, 
                    default="data/ckpt/juggernautXL_juggernautX")
...
for key, item in mapping_file.items():
    ...
    mask_image = cv2.resize(rle2mask(mask,(512,512)),(new_w,new_h))[:,:,np.newaxis]
